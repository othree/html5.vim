...
let role_attributes['alert'] = abstract_role['region'],
let role_attributes['alertdialog'] = abstract_role['alert'],
let role_attributes['button'] = abstract_role['region'] + ['aira-pressed'],
...
let role_attributes['log'] = abstract_role['region'], 
let role_attributes['marquee'] = abstract_role['region'], 
let role_attributes['menuitem'] = abstract_role['input'], 
let role_attributes['menuitemcheckbox'] = abstract_role['menuitem'] + ['aria-checked'],
let role_attributes['menuitemradio'] = role_attributes['menuitemcheckbox'], 
let role_attributes['option'] = role_attributes['input'] + ['aria-checked', 'aria-posinset', 'aria-selected', 'aria-setsize'], 
let role_attributes['progressbar'] = role_attributes['widget'] + ['aria-valuemax', 'aria-valuemin', 'aria-valuenow', 'aria-valuetext'], 
let role_attributes['radio'] = role_attributes['checkbox'], 
let role_attributes['radiogroup'] = role_attributes['select'] + ['aria-required'],
let role_attributes['scrollbar'] = role_attributes['range'] + ['aria-controls', 'aria-orientation', 'aria-valuemax', 'aria-valuemin', 'aria-valuenow'], 
let role_attributes['slider'] = role_attributes['range'] + ['aria-valuemax', 'aria-valuemin', 'aria-valuenow'],  
let role_attributes['spinbutton'] = role_attributes['range'] + ['aria-valuemax', 'aria-valuemin', 'aria-valuenow', 'aria-activedescendant'],   
let role_attributes['status'] = role_attributes['region'] + ['aria-activedescendant'], 
let role_attributes['tab'] = role_attributes['sectionhead'] + ['aria-selected'] , 
let role_attributes['tabpanel'] = role_attributes['region'],
let role_attributes['textbox'] = role_attributes['input'] + ['aria-autocomplete', 'aria-multiline', 'aria-readonly', 'aria-required'], 
let role_attributes['timer'] = role_attributes['status'], 
let role_attributes['tooltip'] = role_attributes['section'], 
let role_attributes['treeitem'] = role_attributes['listitem'] + ['aria-checked', 'aria-posinset', 'aria-selected', 'aria-setsize'],

let role_attributes['grid'] = role_attributes['composite'] + ['aria-level', 'aria-multiselectable', 'aria-readonly'], 
let role_attributes['listbox'] = role_attributes['select'] + ['aria-multiselectable', 'aria-required'], 
let role_attributes['menu'] =  role_attributes['select'], 
let role_attributes['menubar'] = role_attributes['menu'], 
let role_attributes['tablist'] = role_attributes['composite'], 
let role_attributes['toolbar'] = role_attributes['group'], 
let role_attributes['tree'] = role_attributes['select'] + ['aria-multiselectable', 'aria-required'], 
let role_attributes['treegrid'] = role_attributes['grid'] + ['aria-required'], 

let role_attributes['article'] = role_attributes['section'], 
let role_attributes['columnheader'] = role_attributes['gridcell'] + ['aria-sort'], 
let role_attributes['definition'] = role_attributes['section'], 
let role_attributes['directory'] = role_attributes['list'], 
let role_attributes['document'] = role_attributes['structure'] + ['aria-expanded'], 
let role_attributes['heading'] = role_attributes['sectionhead'] + ['aria-level'], 
let role_attributes['img'] = role_attributes['section'], 
let role_attributes['math'] = role_attributes['section'], 
let role_attributes['note'] = role_attributes['section'], 
let role_attributes['presentation'] = role_attributes['structure'],
...
let role_attributes['separator'] = role_attributes['structure'] + ['aria-expanded'] ,

let role_attributes['application'] = role_attributes['landmark'], 
let role_attributes['banner'] = role_attributes['landmark'], 
let role_attributes['complementary'] = role_attributes['landmark'], 
let role_attributes['contentinfo'] = role_attributes['landmark'], 
let role_attributes['form'] = role_attributes['landmark'], 
let role_attributes['main'] = role_attributes['landmark'], 
let role_attributes['navigation'] = role_attributes['landmark'], 
let role_attributes['search'] = role_attributes['landmark']
